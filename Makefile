...
DEF-cputwo         = -DTCC_TARGET_CPUTWO
CRT-cputwo        ?= {B}/lib
LIB-cputwo        ?= {B}
INC-cputwo        ?= {B}/include
...
TCC_X += riscv64 arm64-osx cputwo
...
cputwo_FILES  = $(CORE_FILES) cpuTwo-gen.c cpuTwo-link.c cpuTwo-asm.c cpuTwo-tok.h
